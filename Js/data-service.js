const DataService = {
    ...
    // Cấu trúc lồng nhau: Liên Cụm -> Cụm -> Phường Xã -> Lãnh đạo
    async getClusters() {
        return [
             {
                tenLienCum: "TÂN CHÂU",
                ...
                cums: [
                    {
                        ...
                        phuongXas: [
                            { 
                                id: "PX01", ten: "Thị Trấn Tân Châu", vlr: 2654, danSo: 24072, tram: 9, 
                                lanhDao: [
                                    { ten: "Ông Nguyễn Văn A", chucVu: "Chủ tịch", sdt: "0912.333.444" },
                                    { ten: "Ông Lê Văn B", chucVu: "Trưởng CA", sdt: "0912.555.666" }
                                ] 
                            },
                            { 
                                id: "PX02", ten: "Xã Tân Đông", vlr: 1240, danSo: 27582, tram: 12, 
                                lanhDao: [
                                    { ten: "Bà Trần Thị C", chucVu: "Chủ tịch", sdt: "0988.777.888" }
                                ] 
                            }
                        ]
                    },
                ...
                cums: [
                    {
                        ...
                        phuongXas: [
                            ...
                            { id: "PX05", ten: "Xã Thạnh Tây", vlr: 1500, danSo: 12000, tram: 8, lanhDao: [] }
                        ]
                    }
                ]
            }
    ...
    // a. Cửa hàng (Đã bổ sung ngày thuê để test tính năng Cảnh báo)
    async getStores() {
        return [
            { 
                ...
                // MỚI: Còn hạn dài
                ngayThue: "2020-01-01", ngayHetHan: "2026-06-01" 
            },
            { 
                ...
                // MỚI: Sắp hết hạn (Giả lập cảnh báo < 60 ngày hoặc tùy ngày hiện tại)
                ngayThue: "2019-05-15", ngayHetHan: "2024-12-30" 
            },
            { 
                ...
                // MỚI: Đã hết hạn hoặc cực gấp
                ngayThue: "2021-01-01", ngayHetHan: "2024-05-20" 
            }
        ];
    },
    ...
    // c. Nhân viên Bán hàng (Có Vùng & Phường xã phụ trách)
    async getSalesStaff() {
        return [
            { 
    ...
    // a. Cấu trúc chỉ tiêu (Để render cột động)
    ...
    // b. Số liệu thực hiện (Mock SQL - Dùng để vẽ Chart & Bảng số liệu)
    async getKPIActual(monthFrom, monthTo, keyword) {
        // Dữ liệu này sẽ được filter theo user scope ở main.js
        return [
            ...
            { lienCum: "Tân Biên", cum: "Tân Biên", phuong: "Xã Thạnh Tây", KPI_DT: 200, KPI_TB_MOI: 50, KPI_4G: 90, KPI_CSKH: 9.2 }
        ];
    },

    // c. User ghi nhận (Log nhập liệu)
